  ...
  return (
    <nav className="sticky top-0 z-40 bg-navy-900/80 backdrop-blur-md border-b border-navy-800 px-6 py-4">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 items-center gap-4">
        {/* Brand/Logo */}
        <div className="flex items-center justify-center md:justify-self-start space-x-3 cursor-pointer" onClick={() => setCurrentView('landing')}>
        ...
        <div className="flex flex-wrap justify-center items-center gap-2 bg-navy-950/60 p-1.5 rounded-xl border border-navy-800 justify-self-center">
          {navItems.map((item) => {
        ...
        <div className="flex items-center justify-center md:justify-self-end space-x-4 min-h-10">
          {userRole ? (
